...
class _DeviceSelectionPageState extends State<DeviceSelectionPage> {
  ...
  void _addDevice(String type) {
    showDialog(
      context: context,
      builder: (context) => _TimeCalculatorDialog(
        deviceType: type,
  ...
  void _saveDevices() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        Navigator.pop(context); // Close device selection page
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          title: Text('${device['type']}${multiplayer ? ' (Multiplayer)' : ''} - ${hours}h ${minutes}m'),
